...
public class moon_rocket<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "moon_rocket"), "main");
	private final ModelPart all;

	public moon_rocket(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tube3 = all.addOrReplaceChild("tube3", CubeListBuilder.create().texOffs(0, 51).addBox(-4.9706F, -9.0F, -12.0F, 9.9411F, 18.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(0, 51).addBox(-12.0F, -9.0F, -4.9706F, 24.0F, 18.0F, 9.9411F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -114.0F, 0.0F));

		PartDefinition octagon_r4 = tube3.addOrReplaceChild("octagon_r4", CubeListBuilder.create().texOffs(0, 51).addBox(-12.0F, -9.0F, -4.9706F, 24.0F, 18.0F, 9.9411F, new CubeDeformation(0.0F))
		.texOffs(0, 51).addBox(-4.9706F, -9.0F, -12.0F, 9.9411F, 18.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
