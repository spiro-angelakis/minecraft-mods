...
public class titan_alien<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "titan_alien"), "main");
	private final ModelPart body;

	public titan_alien(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, -37.0F, 0.0F));

		PartDefinition torso = body.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 149).addBox(-18.0F, 2.0F, -32.0F, 36.0F, 28.0F, 30.0F, new CubeDeformation(0.0F))
		.texOffs(0, 178).addBox(-16.5F, 0.0F, -34.0F, 33.1F, 30.0F, 30.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -30.0F, 0.0F));
		...
		PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(25, 83).addBox(-8.0F, 81.0F, -0.8774F, 12.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(-18.0F, -25.0F, -18.0F));
		...
		PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(135, 11).mirror().addBox(-4.0F, 84.0F, -0.8774F, 12.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(18.0F, -28.0F, -18.0F));
		...
		PartDefinition right_leg = body.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(190, 50).addBox(-4.4F, 75.7234F, -9.3287F, 8.7F, 8.0F, 12.8F, new CubeDeformation(0.0F)), PartPose.offset(-16.0F, -24.0F, 24.0F));
		...
		PartDefinition left_leg = body.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(190, 50).mirror().addBox(-4.5F, 74.7234F, -9.2287F, 8.9F, 8.0F, 12.7F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(16.0F, -23.0F, 24.0F));
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, -24.0556F, -29.3429F));
