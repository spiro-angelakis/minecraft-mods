...
public class orbital_rocket<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "orbital_rocket"), "main");
	private final ModelPart all;

	public orbital_rocket(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 0).addBox(-8.0F, -6.0F, -3.3137F, 16.0F, 12.0F, 6.6274F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -113.0F, 0.0F));

		PartDefinition octagon_r4 = tube5.addOrReplaceChild("octagon_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -6.0F, -3.3137F, 16.0F, 12.0F, 6.6274F, new CubeDeformation(0.0F))
