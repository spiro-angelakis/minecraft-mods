...
public class WorldSpace extends ElementsStevesUniverse.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldSpace(ElementsStevesUniverse instance) {
		super(instance, 1);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension space is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("space", "_space", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("music.end",
					(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(("music.end"))), 6000,
					24000);
		}
