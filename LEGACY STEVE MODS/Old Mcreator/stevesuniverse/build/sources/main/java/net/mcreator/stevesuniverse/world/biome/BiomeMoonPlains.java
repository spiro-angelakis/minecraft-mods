...
package net.mcreator.stevesuniverse.world.biome;
...
public class BiomeMoonPlains extends ElementsStevesUniverse.ModElement {
	@GameRegistry.ObjectHolder("stevesuniverse:moonplains")
	public static final BiomeGenCustom biome = null;
	public BiomeMoonPlains(ElementsStevesUniverse instance) {
		super(instance, 3);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Moon Plains").setRainfall(0.5F).setBaseHeight(0.1F).setHeightVariation(0.2F).setTemperature(0.5F));
			setRegistryName("moonplains");
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == BlockMoonTurf.block.getDefaultState().getBlock() || ground == Blocks.STONE.getStateFromMeta(0).getBlock())
