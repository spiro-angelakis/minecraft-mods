...
package net.mcreator.stevesuniverse.world;
...
import net.mcreator.stevesuniverse.block.BlockMoonTurf;
...
public class WorldMoon extends ElementsStevesUniverse.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldMoon(ElementsStevesUniverse instance) {
		super(instance, 4);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension moon is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("moon", "_moon", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockMoonTurf.block.getDefaultState();
		private static final IBlockState STONE2 = Blocks.STONE.getStateFromMeta(0);
		private static final IBlockState FLUID = Blocks.PACKED_ICE.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("stevesuniverse:moonplains")),};
