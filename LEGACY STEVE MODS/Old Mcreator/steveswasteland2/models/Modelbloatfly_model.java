...
public static class Modelbloatfly_model extends ModelBase {
	...
	public Modelbloatfly_model() {
		...
		outer_right_wing.cubeList
				.add(new ModelBox(outer_right_wing, 24, 16, -32.0F, 1.0F, 0.0F, 8, 12, 1, 0.0F, false));
