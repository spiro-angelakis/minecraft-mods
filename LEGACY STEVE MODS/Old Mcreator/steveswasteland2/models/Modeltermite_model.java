...
public static class Modeltermite_model extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.right_pincher.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
		...
		this.left_pincher.rotateAngleX = MathHelper.cos(f * 0.6662F) * f1;
