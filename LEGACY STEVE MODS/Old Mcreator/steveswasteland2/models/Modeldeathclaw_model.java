...
public static class Modeldeathclaw_model extends ModelBase {
	...
	public Modeldeathclaw_model() {
		...
		front_left_shin.cubeList
				.add(new ModelBox(front_left_shin, 226, 138, 21.0F, -1.0F, -3.0F, 6, 16, 6, 0.0F, false));
		...
		front_left_foot.cubeList
				.add(new ModelBox(front_left_foot, 144, 104, 19.0F, 0.0F, -12.0F, 8, 4, 16, 0.0F, false));
		...
		front_right_arm.cubeList
				.add(new ModelBox(front_right_arm, 112, 104, -16.0F, -4.0F, -4.0F, 13, 20, 8, 0.0F, false));
		...
		front_right_shin.cubeList
				.add(new ModelBox(front_right_shin, 226, 138, -27.0F, -1.0F, -3.0F, 6, 15, 6, 0.0F, false));
		...
		front_right_foot.cubeList
				.add(new ModelBox(front_right_foot, 144, 104, -28.0F, 0.0F, -12.0F, 8, 4, 16, 0.0F, false));
		...
		back_right_shin.cubeList
				.add(new ModelBox(back_right_shin, 196, 0, -38.0F, -2.0F, 0.0F, 12, 11, 12, 0.0F, false));
		...
		back_right_foot.cubeList
				.add(new ModelBox(back_right_foot, 112, 0, -41.0F, 0.0F, -20.0F, 12, 6, 24, 0.0F, false));
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.front_right_arm.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
		this.front_left_arm.rotateAngleX = MathHelper.cos(f * 0.6662F) * f1;
