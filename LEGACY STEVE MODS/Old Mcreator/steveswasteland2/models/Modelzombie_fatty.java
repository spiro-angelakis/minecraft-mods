...
public static class Modelzombie_fatty extends ModelBase {
	...
	public Modelzombie_fatty() {
		textureWidth = 64;
		textureHeight = 64;

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, 0.0F, 0.0F);
		head.cubeList.add(new ModelBox(head, 0, 0, -6.0F, 3.0F, -6.0F, 12, 2, 10, 0.0F, false));
		...
		body.cubeList.add(new ModelBox(body, 0, 0, -5.6F, 5.9544F, -5.4791F, 11, 8, 8, 0.0F, false));
