...
public class wooden_spear_entity2<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "wooden_spear_entity2"), "main");
	private final ModelPart all;

	public wooden_spear_entity2(ModelPart root) {
