...
public class big_papa_downward2<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "big_papa_downward2"), "main");
	private final ModelPart all;

	public big_papa_downward2(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon1 = Tip.addOrReplaceChild("hexadecagon1", CubeListBuilder.create().texOffs(31, 172).addBox(11.0F, -1.7902F, -9.0F, 6.0F, 3.5804F, 18.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r5 = hexadecagon1.addOrReplaceChild("hexadecagon_r5", CubeListBuilder.create().texOffs(49, 195).addBox(11.0F, -9.0F, -1.7902F, 6.0F, 18.0F, 3.5804F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r6 = hexadecagon1.addOrReplaceChild("hexadecagon_r6", CubeListBuilder.create().texOffs(147, 195).addBox(11.0F, -9.0F, -1.7902F, 6.0F, 18.0F, 3.5804F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r7 = hexadecagon1.addOrReplaceChild("hexadecagon_r7", CubeListBuilder.create().texOffs(167, 5).addBox(11.0F, -1.7902F, -9.0F, 6.0F, 3.5804F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r8 = hexadecagon1.addOrReplaceChild("hexadecagon_r8", CubeListBuilder.create().texOffs(0, 177).addBox(11.0F, -1.7902F, -9.0F, 6.0F, 3.5804F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagon2 = Thruster.addOrReplaceChild("hexadecagon2", CubeListBuilder.create().texOffs(108, 0).addBox(-1.0F, -0.9946F, -5.0F, 3.0F, 1.9891F, 10.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r25 = hexadecagon2.addOrReplaceChild("hexadecagon_r25", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -5.0F, -0.9946F, 3.0F, 10.0F, 1.9891F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r26 = hexadecagon2.addOrReplaceChild("hexadecagon_r26", CubeListBuilder.create().texOffs(23, 67).addBox(-1.0F, -5.0F, -0.9946F, 3.0F, 10.0F, 1.9891F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r27 = hexadecagon2.addOrReplaceChild("hexadecagon_r27", CubeListBuilder.create().texOffs(23, 0).addBox(-1.0F, -0.9946F, -5.0F, 3.0F, 1.9891F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r28 = hexadecagon2.addOrReplaceChild("hexadecagon_r28", CubeListBuilder.create().texOffs(62, 175).addBox(-1.0F, -0.9946F, -5.0F, 3.0F, 1.9891F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
