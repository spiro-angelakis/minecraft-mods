...
public class spudnik_new3<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "spudnik_new3"), "main");
	private final ModelPart all;

	public spudnik_new3(ModelPart root) {
