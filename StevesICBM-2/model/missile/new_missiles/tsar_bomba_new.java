...
public class tsar_bomba_new<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "tsar_bomba_new"), "main");
	private final ModelPart all;

	public tsar_bomba_new(ModelPart root) {
