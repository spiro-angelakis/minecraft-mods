...
public class spudnik_downward<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "spudnik_downward"), "main");
	private final ModelPart all;

	public spudnik_downward(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition all = partdefinition.addOrReplaceChild("all", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0F, -3.1416F));

		PartDefinition Thruster = all.addOrReplaceChild("Thruster", CubeListBuilder.create(), PartPose.offset(0.0F, 31.0F, 0.0F));
		...
		.texOffs(0, 0).addBox(-12.5F, -5.0F, -2.0711F, 33.0F, 1.0F, 4.1421F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition Top = all.addOrReplaceChild("Top", CubeListBuilder.create(), PartPose.offset(0.0F, -1.7F, 0.0F));
